...
public class App {
    public static void main(String[] args) {
        ...
        Hexagono hexagono = new Hexagono(0,0,0,0,0);
        Pentágono pentágono = new Pentágono(0, 0, 0, 0, 0);
        ...
        pentágono.setLadoP(ladoP);
        pentágono.setApotemaP(apotemaP);
        ...
        System.out.println("Perímetro del Pentágono: " + perimetroHexagono.apply(lado));

        BiFunction<Double, Double, Double> areaHexagono = (perimetro, apotema) -> (perimetro * apotema) / 2;
        System.out.println("Área del Pentágono: " + areaHexagono.apply(perimetroHexagono.apply(lado), apotemaH));
